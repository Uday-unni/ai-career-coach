def github_analysis_prompt(repos_data, job_description):
    return f"""
    You are an expert technical recruiter and senior engineering hiring manager with 12+ years of experience hiring Fullstack, Backend, and Frontend engineers at top product companies.
