...
class AnalyzeResumeView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            ai_result.ats_score = result.get('ats_score', 0)
            ai_result.ats_issues = result.get('ats_issues', [])
            ai_result.ats_keywords_found = result.get('ats_keywords_found', [])
            ai_result.ats_keywords_missing = result.get('ats_keywords_missing', [])
